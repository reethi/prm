                   ...
                   // print_r($data);exit;
                    ...
                    if($admin_old_password!=''){
                       ...
                       // echo "<pre>";print_r($email_list);exit();
                        ...
                        //echo md5($new_password);echo "<br>"; echo $exist_password;
                        //echo "<br>"; echo md5($admin_old_password);exit;
    ...
    if (($_FILES["file"]["type"] == "video/mp4")
        && in_array($extension, $allowedExts))  {
          if ($_FILES["file"]["error"] > 0) {
            $redirect = base_url().'index.php/admin/dashboard/get_video_lists/video_failure';
              ...
              //echo "Stored in: " . "upload/" . $_FILES["file"]["name"];
                ...
                if($result == 1){
                    ...
                    $redirect = base_url().'index.php/admin/dashboard/get_video_lists/video_success';
                    header('Location: ' . filter_var($redirect, FILTER_SANITIZE_URL));      
                        exit;  
                }
                else{
                    $redirect = base_url().'index.php/admin/dashboard/get_video_lists/video_exists';
                     header('Location: ' . filter_var($redirect, FILTER_SANITIZE_URL));
                        exit; 
                }
            ...
            else{ $redirect = base_url().'index.php/admin/dashboard/get_video_lists/video_failure';
                     header('Location: ' . filter_var($redirect, FILTER_SANITIZE_URL));
                        exit;
            }
        }
        ...
        else
        {
          ...
          //echo "Stored in: " . "upload/" . $_FILES["file"]["name"];
            ...
            if($result == 1){
                ...
                $redirect = base_url().'index.php/admin/dashboard/get_doc_lists/doc_success';
                 header('Location: ' . filter_var($redirect, FILTER_SANITIZE_URL));
                    exit; 
            }
            else if($result == 'updated'){
                $redirect = base_url().'index.php/admin/dashboard/get_doc_lists/doc_exists';
                header('Location: ' . filter_var($redirect, FILTER_SANITIZE_URL));
                    exit; 
            }
            else{
                $redirect = base_url().'index.php/admin/dashboard/get_doc_lists/doc_failure';
                     header('Location: ' . filter_var($redirect, FILTER_SANITIZE_URL));
                        exit;
            }
        }
    }
    else{ $redirect = base_url().'index.php/admin/dashboard/get_doc_lists/doc_failure';
                     header('Location: ' . filter_var($redirect, FILTER_SANITIZE_URL));
                        exit;
        }
}
...
public function videoUploadEdit(){
    ...
    else{ $redirect = base_url().'index.php/admin/dashboard/get_doc_lists/video_failure';
                     header('Location: ' . filter_var($redirect, FILTER_SANITIZE_URL));
                        exit;
        }
}
