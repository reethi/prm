        ...
        <div class="page-container">
            ...
            <div class="page-sidebar" id="sidebar">
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <li>
                        <a href="#"  class="add_participant_open" data-toggle="modal" data-target="#add_participant_popup">
                            <i class="menu-icon fa fa-edit"></i>
                            <span class="menu-text"> <span style="font-weight:600;">Add Participant</span> </span>
                        </a>
                    </li>
                    <li>
                        <a href="#"  class="submit_weight_open" data-toggle="modal" data-target="#submit_weight_pop" >
                            <i class="menu-icon fa fa-plus-square"></i>
                            <span class="menu-text"> <span style="font-weight:600;">Submit Weight</span> </span>
                        </a>
                    </li>
                    <li>
                        <a href="#"  class="add_attendance_open" data-toggle="modal" data-target="#add_attendance_pop">
                            <i class="menu-icon fa fa-user"></i>
                            <span class="menu-text"> <span style="font-weight:600;">Submit Attendance</span> </span>
                        </a>
                    </li>
                    <li class="<?= ($action == 'docslist') ? 'active' : '' ?>">
                         <!--<a href="#" data-toggle="modal" data-target="#create_doc_popup">-->
                            <a href="<?php echo base_url(); ?>index.php/admin/dashboard/get_doc_lists">
                            <i class="menu-icon fa fa-file"></i>
                            <span class="menu-text"> <span style="font-weight:600;">Upload Document</span> </span>
                        </a>
                    </li>
                    <li class="<?= ($action == 'videoslist') ? 'active' : '' ?>">
                        <a href="<?php echo base_url(); ?>index.php/admin/dashboard/get_video_lists">
