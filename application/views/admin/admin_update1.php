...
<div class="page-body">
    ...
    <div class="col-lg-6 col-md-8 col-sm-8 col-xs-12">
        ...
        <form action="<?php echo base_url(); ?>index.php/admin/dashboard/edit_profile" id="admin_update_profile" method="post" enctype="multipart/form-data">
            <div class="widget-body" style="background-color: white;">
                <div class="row">
                    <div class="col-md-4 col-sm-5">
                        <div style="padding-bottom:10px; ">
                        <?php if(isset($values->profile_pic) && $values->profile_pic!='') { ?>
                            <img src="<?php echo base_url();?>assets/images/<?php echo $values->profile_pic;?>">
                        <?php } else{ ?>
                            <img src="<?php echo base_url();?>assets/images/profile_image.png">
                            <?php } ?>
                        </div>
                        <div style="padding-left:10px; ">
                            <label class="myLabel">Change
                                 <input type="file" name="file" id="file" class="yes_button" /> &nbsp;
                            </label>
                            <a class="menu-text" style="color:blue;cursor:pointer" data-toggle="modal" data-target="#delete_profile">
                    ...
                    <div class="col-md-6 col-sm-7 details-res text-right" style="padding-top: 15px !important;">
                            ...
                            <div style="padding-left:10px; ">
                                ...
                                <input type="submit" class="yes_button" value="Save">
                            </div>
                    </div>
                </div>
            </div><!--Widget Body-->
